    ...
    function render() {
        ...
        state.body.replaceChildren(
            h('div', { class: 'scanwrap' },
                state.fromCache ? h('div', { class: 'cachenote' },
                    h('span', null, `Loaded from saved cache${state.intel.scannedAt ? ` (${new Date(state.intel.scannedAt).toLocaleString()})` : ''} — live offers are frozen at save time.`),
